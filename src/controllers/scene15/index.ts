...
export class SceneFifteen {
    private static page: Page

    constructor(page: Page) {
        SceneFifteen.page = page
        SceneFifteen.init()
    }
    ...
    public static async init() {
        try {
            ...
            const ENUM_FORM_COMPONENTS = {
                ...
                PERIOD: 'period',
                MESSAGE_FROM_THE_ORGANIZATION: 'message_from_the_organization',
                START_DATE: 'start_date',
                REQUEST_COME_FROM: 'request_come_from',
                TYPE: 'type',
                DESCRIPTION: 'description',
                NATURE_TREATMENT: 'nature_treatment',
                DETAIL: 'detail',
            ...
            Logger.log('SceneFifteen initialization.')

            const procedureMigration = async (pageIndex = 1) => {
                Logger.log('F[procedureMigration] - Procedure migration by page', pageIndex, '- starting')

                const url = getUrlIssueOfProjectByQueryId('sustainability_initiativeu', '6718', pageIndex, 750)
                ...
                for (const selectedId of ids) {
                    ...
                    if (SceneFifteen.getSuccessLoadedList().includes(selectedId)) {
                                    ...
                                    try {
                                        ...
                                        switch (key) {
                                            ...
                                            case ENUM_FORM_COMPONENTS.PERIOD:
                                                fieldCode = '319'
                                                break;
                                            case ENUM_FORM_COMPONENTS.MESSAGE_FROM_THE_ORGANIZATION:
                                                fieldCode = '3444'
                                                break;
                                            case ENUM_FORM_COMPONENTS.START_DATE:
                                                fieldCode = '3417'
                                                break;
                                            case ENUM_FORM_COMPONENTS.REQUEST_COME_FROM:
                                                fieldCode = '3377'
                                                break;
                                            case ENUM_FORM_COMPONENTS.TYPE:
                                                fieldCode = '1089'
                                                break;
                                            case ENUM_FORM_COMPONENTS.DESCRIPTION:
                                                fieldCode = '1079'
                                                break;
                                            case ENUM_FORM_COMPONENTS.NATURE_TREATMENT:
                                                fieldCode = '3378'
                                                break;
                                            case ENUM_FORM_COMPONENTS.DETAIL:
                                                fieldCode = '3380'
                                                break;
                                            case ENUM_FORM_COMPONENTS.MEASURES_TAKEN:
                                                fieldCode = '3379'
                                                break;
                                            case ENUM_FORM_COMPONENTS.COMMENTS:
                                                fieldCode = '58'
                                                break;
