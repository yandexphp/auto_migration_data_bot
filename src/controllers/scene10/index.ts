    ...
    public static async init() {
        try {
            ...
            const ENUM_FORM_COMPONENTS = {
                ...
                KOMP14: 'KOMP14',
                KOMP15: 'komp15',
                COMPETENCE_TWO: 'competence_two',
                KOMP22: 'komp22',
                KOMP23: 'komp23',
                KOMP24: 'komp24',
                KOMP25: 'komp25',
                DESCRIPTION3: 'description3',
                COMPETENCE_THREE: 'competence_three',
                COMPETENCE_FOUR: 'competence_four',
                KOMP27: 'komp27',
                COMPETENCE_FIVE: 'competence_five',
                COMPETENCE_SIX: 'competence_six',
                KOMP28: 'komp28',
                EDUCATION: 'education',
            ...
            const procedureMigration = async (pageIndex = 1) => {
                ...
                for (const selectedId of ids) {
                    ...
                    if (SceneTen.getSuccessLoadedList().includes(selectedId)) {
                                    ...
                                    try {
                                        ...
                                        switch (key) {
                                            case ENUM_FORM_COMPONENTS.COMPANY_NAME:
                                                fieldCode = '29'
                                                break;
                                            case ENUM_FORM_COMPONENTS.DEPARTMENT:
                                                fieldCode = '431'
                                                break;
                                            ...
                                            case ENUM_FORM_COMPONENTS.YEAR:
                                                fieldCode = '320'
                                                break;
                                            case ENUM_FORM_COMPONENTS.COMPETENCE_ONE:
                                                fieldCode = '538'
                                                break;
                                            case ENUM_FORM_COMPONENTS.DESCRIPTION:
                                                fieldCode = '3505'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP12:
                                                fieldCode = '543'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP13:
                                                fieldCode = '750'
                                                break;
                                            case ENUM_FORM_COMPONENTS.DESCRIPTION2:
                                                fieldCode = '3509'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP14:
                                                fieldCode = '544'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP15:
                                                fieldCode = '751'
                                                break;
                                            case ENUM_FORM_COMPONENTS.COMPETENCE_TWO:
                                                fieldCode = '539'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP22:
                                                fieldCode = '541'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP23:
                                                fieldCode = '752'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP24:
                                                fieldCode = '542'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP25:
                                                fieldCode = '753'
                                                break;
                                            case ENUM_FORM_COMPONENTS.DESCRIPTION3:
                                                fieldCode = '3512'
                                                break;
                                            case ENUM_FORM_COMPONENTS.COMPETENCE_THREE:
                                                fieldCode = '???'
                                                break;
                                            case ENUM_FORM_COMPONENTS.COMPETENCE_FOUR:
                                                fieldCode = '???'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP27:
                                                fieldCode = '754'
                                                break;
                                            case ENUM_FORM_COMPONENTS.COMPETENCE_FIVE:
                                                fieldCode = '???'
                                                break;
                                            case ENUM_FORM_COMPONENTS.COMPETENCE_SIX:
                                                fieldCode = '???'
                                                break;
                                            case ENUM_FORM_COMPONENTS.KOMP28:
                                                fieldCode = '???'
                                                break;
                                            case ENUM_FORM_COMPONENTS.EDUCATION:
                                                fieldCode = '???'
                                                break;
                                            case ENUM_FORM_COMPONENTS.EDUCATION_THREE:
                                                fieldCode = '???'
                                                break;
                                            case ENUM_FORM_COMPONENTS.OPISANIE5:
                                                fieldCode = '756'
                                                break;
                                            ...
                                            case ENUM_FORM_COMPONENTS.FULL_NAME:
                                                ...
                                                switch (key) {
                                                    case ENUM_FORM_COMPONENTS.FULL_NAME:
                                                        if(xmlContentUserProfile) {
                                                            const xmlObjectUserProfile = xmlParser.parse(xmlContentUserProfile)

                                                            if(xmlObjectUserProfile) {
                                                                const {person: {person}} = xmlObjectUserProfile
                                                                const authorId = await searchEkapUserIdByUsername(person.login, ekapConfigRequest)
