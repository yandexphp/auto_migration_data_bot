...
export class SceneFourteen {
    private static page: Page

    constructor(page: Page) {
        SceneFourteen.page = page
        SceneFourteen.init()
    }
    ...
    public static async init() {
        try {
            ...
            Logger.log('SceneFourteen initialization.')

            const procedureMigration = async (pageIndex = 1) => {
                Logger.log('F[procedureMigration] - Procedure migration by page', pageIndex, '- starting')

                const url = getUrlIssueOfProjectByQueryId('information_about_vacancies', '6522', pageIndex, 750)
                ...
                for (const selectedId of ids) {
                    ...
                    if (SceneFourteen.getSuccessLoadedList().includes(selectedId)) {
                                    ...
                                    try {
                                        ...
                                        switch (key) {
                                            ...
                                            case ENUM_FORM_COMPONENTS.NAME_STRING:
                                                fieldCode = '3648'
                                                break;
                                            case ENUM_FORM_COMPONENTS.NAME_POSITION:
                                                fieldCode = '3649'
                                                break;
                                            ...
                                            case ENUM_FORM_COMPONENTS.START_DATE:
                                                fieldCode = '3651'
                                                break;
                                            case ENUM_FORM_COMPONENTS.TEMPORARY_DATE:
                                                fieldCode = '3652'
                                                break;
                                            case ENUM_FORM_COMPONENTS.PLACE:
                                                fieldCode = '3653'
                                                break;
