...
export class SceneEleven {
    private static page: Page

    constructor(page: Page) {
        SceneEleven.page = page
        SceneEleven.init()
    }
        ...
        try {
            ...
            const procedureMigration = async (pageIndex = 1) => {
                ...
                for (const selectedId of ids) {
                    ...
                    if (SceneEleven.getSuccessLoadedList().includes(selectedId)) {
                                    ...
                                    try {
                                        ...
                                        switch (key) {
                                            ...
                                            case ENUM_FORM_COMPONENTS.COMPANY_NAME:
                                                fieldCode = '3490'
                                                break;
                                            case ENUM_FORM_COMPONENTS.TOTAL_AMOUNT5:
                                                fieldCode = '3491'
                                                break;
                                            case ENUM_FORM_COMPONENTS.TOTAL_AMOUNT6:
                                                fieldCode = '3492'
                                                break;
                                            case ENUM_FORM_COMPONENTS.CONDITIONS:
                                                fieldCode = '3493'
                                                break;
                                            case ENUM_FORM_COMPONENTS.STUDENT:
                                                fieldCode = '3496'
                                                break;
                                            case ENUM_FORM_COMPONENTS.STUDENT2:
                                                fieldCode = '3497'
                                                break;
                                            case ENUM_FORM_COMPONENTS.STUDENT3:
                                                fieldCode = '3498'
                                                break;
                                            case ENUM_FORM_COMPONENTS.STUDENT4:
                                                fieldCode = '3499'
                                                break;
